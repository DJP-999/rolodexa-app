...
export const channel = pgEnum("channel", ["nylas_email","nylas_calendar","telegram","imessage","agent_audit"]);
...
export const contacts = pgTable("contacts", {
  ...
  gradeRationale: text("grade_rationale"), embedding: vector("embedding", { dimensions: 1536 }),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
